                     ...
                     <form action="" method="get">
                        <div class="row">
                           ...
                           <div class="col-md-3 searchBoxContainer">
                              <div class="input-group">
                                 <input type="text" name="search" class="form-control searchInput" placeholder="Sanction Officer...">
                           ...
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="marketing/cm-report-fresh-repeated" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
