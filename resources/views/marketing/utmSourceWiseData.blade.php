...
<div class="container-fluid">
                     ...
                     <form action="" method="get">
                        <div class="row">
                           ...
                           <div class="col-md-3 searchBoxContainer">
                              <div class="input-group">
                                 <input type="text" name="search" class="form-control searchInput" placeholder="Status...">
                           ...
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="marketing/utm-source-wise" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
 ...
 <table class="table table-centered table-nowrap table-hover mb-0">
    ...
    <tbody>
        @forelse($utmSourceWiseData as $data)
            <tr>
