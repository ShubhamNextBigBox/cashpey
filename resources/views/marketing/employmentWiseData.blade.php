   ...
   <div class="row">
                     ...
                     <form action="" method="get">
                        <div class="row">
                           ...
                           <div class="col-md-3 searchBoxContainer">
                              <div class="input-group">
                                 <input type="text" name="search" class="form-control searchInput" placeholder="Employment Status...">
                           ...
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="marketing/employment-wise" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
    ...
    <thead>
        <tr class="bg-primary">
            ...
            <th class="text-white">Total Count</th>
            <th class="text-white">Percentage</th>
        </tr>
    </thead>
    <tbody>
        @forelse($employmentWiseData as $data)
            <tr>
                <td>{{ $data->employed }}</td>
