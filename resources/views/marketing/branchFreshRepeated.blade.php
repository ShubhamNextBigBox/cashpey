                     ...
                     <form action="" method="get">
                        <div class="row">
                           ...
                           <div class="col-md-3 searchBoxContainer">
                              <div class="input-group">
                                 <input type="text" name="search" class="form-control searchInput" placeholder="Branches...">
                           ...
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="marketing/branch-report-fresh-repeated" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
            ...
            <div class="card-body" data-simplebar data-simplebar-lg style="overflow-x:auto;">
               <table class="table table-centered table-nowrap table-hover mb-0">
                   ...
                   <tbody>
                       ...
                       @if(count($branchFreshRepeatData) > 0)
                           @foreach($branchFreshRepeatData as $arr)
                               @php
