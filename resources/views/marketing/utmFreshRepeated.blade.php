         ...
         <div class="card">
                     ...
                     <form action="" method="get">
                        <div class="row">
                           ...
                           <div class="col-md-3 searchBoxContainer">
                              <div class="input-group">
                                 <input type="text" name="search" class="form-control searchInput" placeholder="UTM Source...">
                                 <button class="btn btn-primary" type="submit" id="searchButton">
                                 <i class="uil uil-search"></i>
                                 </button>
                              </div>
                           </div>
                            <div class="col-md-3 dateRangeContainer" style="{{ $filter === 'sortByDate' ? '' : 'display: none;' }}">
                                <div class="input-group">
                                    <input type="text" class="form-control date singledaterange" name="searchRange" value="{{ request()->get('searchRange') }}" data-toggle="date-picker" data-cancel-class="btn-warning">
                           ...
                           @endif
                           @if(rolesAccess('UTM Fresh Vs Repeated', 'export') || isSuperAdmin() || isAdmin())
                           ...
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="marketing/utm-fresh-repeated-wise" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
            ...
            <div class="card-body" data-simplebar data-simplebar-lg style="overflow-x:auto;">
               <table class="table table-centered table-nowrap table-hover mb-0">
                   <thead>
                        <tr class="bg-primary">
                           <th class="text-white">UTM Source</th>
                   ...
                   <tbody>
                       ...
                       @if(count($utmFreshRepeatData) > 0)
                           @foreach($utmFreshRepeatData as $arr)
                               @php
