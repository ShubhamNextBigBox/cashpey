                 ...
                 <div class="col-md-12">
                     <form action="" method="get">
                          ...
                          <div class="col-md-3">
                           ...
                           <div class="input-group">
                              ...
                              <select class="form-select exportSelect" name="filter">
                                 ...
                                 @endif
                                 @if(rolesAccess('Disbursal Sheet Send', 'export') || isSuperAdmin() || isAdmin())
                        ...
                        @endif
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="disbursal/disbursal-sheet-send" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
