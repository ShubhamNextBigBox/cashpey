                 ...
                 <div class="col-md-12">
                     <form action="" method="get">
                        ...
                        @endif
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="sanction/approved" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
               ...
               <table  class="table w-100 table-striped" style="white-space: nowrap;">
                  ...
                  <tbody>
                     ...
                     <tr style="font-size:15px;">
                        ...
                        <td>{{$arr->approval_tenure}} Days</td>
                        <td>{{$arr->roi}} %</td>
                        ...
                        <td>{{dft($arr->approval_addedOn)}}</td>
                     </tr>
                     @endforeach
                     @endif
                  </tbody>
