               ...
               <div class="row">
                 <div class="col-md-12">
                     <form action="" method="get">
                        ...
                        @endif
                        @if(rolesAccess('E-Nach Registration', 'export') || isSuperAdmin() || isAdmin())
                        ...
                        @endif
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="sanction/enach" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
               ...
               <table  class="table w-100 table-striped" style="white-space: nowrap;">
                  ...
                  <tbody>
                     ...
                     <tr style="font-size:15px;">
                        ...
                        <td>{{$arr->leadID}}</a></td>
                        <td>{{$arr->status}}</td>
                        <td>{{$arr->consumerID}}</td>
                        <!--<td>CREDITPEY4908</td>-->
                        <td>{{$arr->mandate_reg_no}}</td>
                        <td>{{$arr->cusName}}</td>
                        <td>{{$arr->cusEmail}}</td>
                        <td>{{$arr->cusPan}}</td>
                        <td>{{$arr->accountNo}}</td>
                        <td>{{$arr->ifscCode}}</td>
                        <td>{{$arr->enachAmount}}</td>
                        <td>{{$arr->scheduleDate}}</td>
                        <td>{{$arr->expiryDate}}</td>
                        <td>{{$arr->tpsl_txn_time}}</td>
                     </tr>
                     @endforeach
                     @endif
                  </tbody>
