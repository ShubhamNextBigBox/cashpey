        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h4 class="modal-title" id="primary-header-modalLabel">ROI Details</h4>
                ...
                <div class="modal-body">
                   <form method="post" id="leadsStatusAddEditModalForm">
                    @csrf
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">ROI:</label>
                        <input type="number" step="any" class="form-control" name="roi" id="roi" placeholder="Enter ROI">
       ...
       $(document).ready(function() {
        ...
        $(document).on('click','#addNewBtn',function(){
          ...
          $(document).on('submit','#leadsStatusAddEditModalForm',function(event) {
                ...
                var id = $('#id').val();
                var url = (id !== '') ? '{{ route('roiUpdate') }}' : '{{ route('roiAdd') }}';
                $.ajax({
                   url: url,
                   type: "POST",
                   dataType:'json',
