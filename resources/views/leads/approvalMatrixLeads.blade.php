                  ...
                  <div class="col-md-12">
                     <form action="" method="get">
                        <div class="row">
                           ...
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="leads/approval-matrix-leads" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
               ...
               <table id="basic-datatable" class="table dt-responsive nowrap w-100 branchTable table-striped">
                  ...
                  <tbody>
                     ...
                     <tr style="font-size:15px;">
                        ...
                        <td>
                           @if($arr->creditStatus=='Approved')
                           <span class="badge bg-success">{{$arr->creditStatus}}</span>
                           @elseif($arr->creditStatus=='Rejected')
                           <span class="badge bg-danger">{{$arr->creditStatus}}</span>
                           @else
                           <span class="badge bg-info">{{$arr->creditStatus}}</span>
                           @endif
                        </td>
                        ...
                        <td>{{getUserNameById('users', 'userID',$arr->matrixApprovalBy, 'displayName')}}</td>
