                 ...
                 <div class="col-md-12">
                     <form action="" method="get">
                        <div class="row">
                           ...
                           <div class="input-group">
                              ...
                              <select class="form-select exportSelect" name="filter">
                                 ...
                                 @endif
                                 @if(rolesAccess('Settlement', 'export') || isSuperAdmin() || isAdmin())
                        ...
                        @endif
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="collection/settlement" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
