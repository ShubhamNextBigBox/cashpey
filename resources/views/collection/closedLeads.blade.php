                 ...
                 <div class="col-md-12">
                     <form action="" method="get">
                        <div class="row">
                           ...
                           <div class="input-group">
                              ...
                              <select class="form-select exportSelect" name="filter">
                                 ...
                                 @endif
                                 @if(rolesAccess('Closed', 'export') || isSuperAdmin() || isAdmin())
                        ...
                        @endif
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="collection/closed" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
