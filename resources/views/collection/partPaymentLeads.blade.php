                 ...
                 <div class="col-md-12">
                     <form action="" method="get">
                        <div class="row">
                           ...
                           <div class="input-group">
                              ...
                              <select class="form-select exportSelect" name="filter">
                                 ...
                                 @endif
                                 @if(rolesAccess('Part Payment', 'export') || isSuperAdmin() || isAdmin())
                        ...
                        @endif
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="collection/part-payment" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
