                 ...
                 <div class="col-md-12">
                     <form action="" method="get">
                          ...
                          <div class="col-md-3">
                           ...
                           <div class="input-group">
                              ...
                              <select class="form-select exportSelect" name="filter">
                                 ...
                                 @endif
                                 @if(rolesAccess('Settled To Closed Wise', 'export') || isSuperAdmin() || isAdmin())
                        ...
                        @endif
                           @if(!empty($filter))
                           <div class="col-md-1">
                              <a href="collection/settled-to-closed" class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="success">
               ...
               <table  class="table w-100 table-striped" style="white-space: nowrap;">
                  ...
                  <tbody>
                     ...
                     <tr style="font-size:15px;">
                        ...
                        <td>{{nf($arr->discountAmount)}}</td>
                        <td>{{nf($arr->settlementAmount)}}</td>
                        <td>{{$arr->status}}</td>
